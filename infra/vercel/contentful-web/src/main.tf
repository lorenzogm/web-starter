locals {
  ...
  secrets = {
    ...
    CONTENTFUL_DELIVERY_API_ACCESS_TOKEN   = var.CONTENTFUL_DELIVERY_API_ACCESS_TOKEN
    CONTENTFUL_PREVIEW_API_ACCESS_TOKEN    = var.CONTENTFUL_PREVIEW_API_ACCESS_TOKEN
  }
  environments = {
    "development" = "dev"
    "staging"     = "stg"
